...
Achievements::Achievements()
{
    ...
    CCScrollView *scrollView = CCScrollView::create(CCSizeMake(470*scaleX, 190*scaleY),container);
    scrollView->setContentSize(menu_size);
    scrollView->updateInset();
    scrollView->setContentOffset(ccp(0.0f,-menu_size.height+(190*scaleY)));
    scrollView->setDirection(kCCScrollViewDirectionVertical);
    scrollView->setPosition(ccp((480*scaleX-menu_size.width)*0.5f,30*scaleY));
    addChild(scrollView);
